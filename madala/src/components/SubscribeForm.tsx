...
export default function SubscribeForm() {
  return (
    <div>
      <h2 className="text-lg font-bold text-center text-gray-800 mb-1">GỬI EMAIL CHO CHÚNG TÔI</h2>
      ...
      <div className="bg-gray-100 p-6 rounded-lg shadow-sm">
        <p className="text-center text-3xl text-gray-500 font-bold mb-1">Gửi email</p>
        <p className="text-center text-lg text-gray-500 mb-4">để nhận những ưu đãi mới nhất</p>
