...
import { userMenuItems, guestMenuItems, navigationItems, HEADER_ROUTES, MenuItem } from "@/constants/headerLinks";
          ...
          <Link className="flex items-center space-x-3" href="/">
            <div className="flex items-center">
              <span className="flex items-center justify-center w-12 h-12 rounded-full" style={{ background: 'hsl(88 50% 53%)' }}>
                <span className="ml-2 text-3xl text-white font-[cursive] italic font-bold tracking-tight">M</span>
              </span>
          ...
          <div className="flex items-center gap-4">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex flex-col items-center text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none transition-colors h-auto p-2">
